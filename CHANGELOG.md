...
* **AppPasswordField:** make prefixIcon optional and default to null ([88c4dc4](https://github.com/Mensa-Philosophical-Circle/Swiss-Army/commit/88c4dc4d05a8034c5bfc0f4605e7a3478621849f))
...
* remove all hardcoded AppColors and GoogleFonts.poppins fallbacks; widgets now fully respect Theme.of(context).colorScheme ([95c998f](https://github.com/Mensa-Philosophical-Circle/Swiss-Army/commit/95c998f3e5f89bc9c229d3f0dbaa42aeae0eb8dd))
...
- **AppPasswordField**: Removed forced `Icons.lock_outline` prefix icon default so `AppPasswordField` defaults to clean no-prefix-icon styling matching modern form designs.
...
- **AppPhoneTextField**: Replaced platform emoji flags with high-fidelity asset PNG flags from `intl_phone_field`, resolving missing/broken emoji flag rendering across Android/iOS.
- **AppPhoneTextField**: Redesigned country code selector dialog with searchable bottom sheet, smooth styling, and cleaner layout.
- **AppPhoneTextField**: Removed extraneous character counter display.
